...
make_group(gp1, EX(add), EX(or), EX(adc), EX(sbb), EX(and), EX(sub), EX(xor),
    ...
    make_group(gp2, EX(rol), EMPTY, EMPTY, EMPTY, EXW(shl, 1), EX(shr), EMPTY,
               EXW(sar, 1))
    ...
    /* 0xfe */
    make_group(gp4, EMPTY, EXW(dec, 1), EMPTY, EMPTY, EMPTY, EMPTY, EMPTY,
               EMPTY)
    ...
    opcode_entry opcode_table[512] = {
        ...
        /* 0x68 */ IDEX(push_SI, push), EMPTY, IDEXW(push_SI, push, 1),
        IDEX(I_E2G, imul3),
